...
I recommend reading `Report.Rmd` in your browser since GitHub truncates `Report.html`. ("Sorry about that, but we can’t show files that are this big right now.")